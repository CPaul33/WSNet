...
class ValSetLoader(Dataset):
    def __init__(self, dataset_dir, train_dataset_name, val_dataset_name, img_norm_cfg=None):
        super(TestSetLoader).__init__()
        self.dataset_dir = dataset_dir + '/' + val_dataset_name
        with open(self.dataset_dir + '/img_idx/val_' + val_dataset_name + '.txt', 'r') as f:
